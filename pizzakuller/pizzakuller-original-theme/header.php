...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=PT+Serif:400italic,700italic&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
        <title><?php
            /*
...
// Add a page number if necessary:
  ...
  ga('create', 'UA-48581050-1', 'pizzakuller.ee');
  ga('send', 'pageview');
    ...
    <body <?php body_class(); ?>>
        ...
        <div id="popupwarn" class="popup-warning">
            <div class="content">
                ...
                <h1><?php _e('[:en]If you choose new place, then your basket will be reseted![:et]Uue toidukoha valimisel ostukorv tühjendatakse![:ru]При выборе нового места заказ обнуляется!'); ?></h1>
                <h5><?php _e('[:en]You can order only one place at time.[:et]Tellida saab ühest toidukohast korraga.[:ru]Заказать можно только с одного места.'); ?></h5>

                <a href="javascript: void(0);" class="action_continue"><img src="<?php echo get_template_directory_uri() . '/images/arrow_right.png'; ?>"/><div><?php _e('[Reset basket'); ?></div></a>
                <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>?empty-cart" class="action_close"><img src="<?php echo get_template_directory_uri() . '/images/arrow_left.png'; ?>"/> <div><?php _e('Back'); ?></div></a>
            ...
            <header>
                ...
                <?php if (is_home() || is_front_page()): ?>
                    ...
                    <div id="slider">
                        ...
                        <?php } ?>
                        <?php if (qtrans_getLanguage() == 'et') { ?>
                            <?php putRevSlider("slider1", "homepage") ?>

                        <?php } ?>
                        <?php if (qtrans_getLanguage() == 'ru') { ?>
                            <?php putRevSlider("slider3", "homepage") ?>
