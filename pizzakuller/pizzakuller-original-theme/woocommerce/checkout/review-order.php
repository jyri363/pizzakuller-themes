...
?>
<div id="order_review">
    <h3><?php _e('[:en]Order review[:et]Tellimuse ülevaade[:ru]Обзор заказа'); ?></h3>
            ...
            if (sizeof($woocommerce->cart->get_cart()) > 0) :
                foreach ($woocommerce->cart->get_cart() as $cart_item_key => $values) :
                    ...
                    if ($_product->exists() && $values['quantity'] > 0) :
                        ...
                        echo '<div class="hidden" id="product-categories">
    ...
    <div id="payment">
        ...
        <div class="form-row place-order">
            ...
            echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="checkout-button3" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />');
            ?>
