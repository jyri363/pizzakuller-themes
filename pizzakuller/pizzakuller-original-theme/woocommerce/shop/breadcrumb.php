...
//===============================
//Bread Crumbs Globals
//===============================

$wrap_before = '<div class="breadcrumbs"><ul>'; //breadcrumb wrapper
$wrap_after = '</ul></div>';
$before = '<li>'; //element wrappet
$after = '</li>';
$delimiter = ''; // separator
...
if ( ( ! is_home() && ! is_front_page() && ! ( is_post_type_archive() && get_option( 'page_on_front' ) == woocommerce_get_page_id( 'shop' ) ) ) || is_paged() ) {
	...
	if ( get_query_var( 'paged' ) )
		echo ' <li>(' . __( 'Page', 'woocommerce' ) . ' ' . get_query_var( 'paged' ) . ')</li>';
