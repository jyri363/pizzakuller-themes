...
<form class="variations_form cart" action="<?php echo qtrans_convertURL('', qtrans_getLanguage()); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo $post->ID; ?>" data-product_variations="<?php echo esc_attr(json_encode($available_variations)) ?>">
    ...
    <div class="single_variation_wrap" style="display:none;">
        ...
        </div><div style="width:320px !important; margin:0 auto !important; text-align:center !important;"><button type="submit" class="checkout-button2" style="margin-top:55px; position:absolute;"><?php echo apply_filters('single_add_to_cart_text', __('Add to cart', 'woocommerce'), $product->product_type); ?></button></div>
    </div>
